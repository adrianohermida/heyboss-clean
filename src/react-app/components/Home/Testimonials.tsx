      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="bg-[var(--color-cardElevated)] border border-[var(--color-border)]/10 shadow-xl p-8 rounded-3xl relative flex flex-col h-full">
              ...
              <p className="italic mb-8 leading-relaxed text-[var(--color-text-secondary)]/90 text-base">"{t.text}"</p>
              <div className="flex items-center gap-4 mt-auto">
                ...
                <div>
                  ...
                  <p className="text-[var(--color-text-secondary)]/60 text-xs">Cliente Verificado</p>
                </div>
              </div>
            </div>
          ))}
